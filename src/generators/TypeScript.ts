...
var elementClass: ClassDeclarationStructure = {
  docs: [
    {
      description: "A FHIR data element",
    },
  ],
  ctors: [
    {
...
var resourceClass: ClassDeclarationStructure = {
  docs: [
    {
      description: "Base class for all FHIR resources",
    },
  ],
  ctors: [
    {
